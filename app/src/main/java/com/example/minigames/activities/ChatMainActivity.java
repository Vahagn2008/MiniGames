...
public class ChatMainActivity extends AppCompatActivity implements ConversionListener {
    ...
    private RecentConversationAdapter conversatiosAdapter;
    ...
    private void init() {
        ...
        conversatiosAdapter = new RecentConversationAdapter(conversations, this);
        binding.conversationsRecyclerView.setAdapter(conversatiosAdapter);
    ...
    private final EventListener<QuerySnapshot> eventListener = (value, error) -> {
        ...
        if(value != null) {
            ...
            conversatiosAdapter.notifyDataSetChanged();
