...
import com.example.minigames.adapters.ChatAdapter;
import com.example.minigames.databinding.ActivityChatBinding;
import com.example.minigames.models.ChatMessage;
import com.example.minigames.models.User;
import com.example.minigames.network.ApiClient;
import com.example.minigames.network.ApiService;
...
public class ChatActivity extends BaseActivity {
    ...
    private void sendNotification(String messageBody) {
        ApiClient.getClient().create(ApiService.class).sendMessage(
                Constants.getRemoteMsgHesaders(),
                messageBody
