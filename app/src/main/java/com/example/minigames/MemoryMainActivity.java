...
public class MemoryMainActivity extends AppCompatActivity {
    ...
    private void checkEnd() {
        if (iv_11.getVisibility() == View.INVISIBLE &&
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MemoryMainActivity.this);
            alertDialogBuilder
                    ...
                    .setPositiveButton("NEW", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Intent intent = new Intent(getApplicationContext(), MemoryMainActivity.class);
                    ...
                    .setNegativeButton("EXIT", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Intent intent = new Intent(MemoryMainActivity.this, MainActivity.class);
                            startActivity(intent);
                        }
                    });
