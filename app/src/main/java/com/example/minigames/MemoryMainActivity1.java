...
public class MemoryMainActivity1 extends AppCompatActivity {

    TextView tv__p1, tv__p2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_memory_main1);

        tv__p1 = (TextView) findViewById(R.id.tv__p1);
        tv__p2 = (TextView) findViewById(R.id.tv__p2);
        ...
        tv__p2.setTextColor(Color.GRAY);
    ...
    private void calculate() {
        if (firstCard == secondCard) {
            ...
            if (turn == 1) {
                playerPoints++;
                tv__p1.setText("P1: " + playerPoints);
            } else if (turn == 2) {
                cpuPoints++;
                tv__p2.setText("P2: " + cpuPoints);
            }
        } else {
            iv_11.setImageResource(R.drawable.ic_back1);
            iv_12.setImageResource(R.drawable.ic_back1);
            iv_13.setImageResource(R.drawable.ic_back1);
            iv_14.setImageResource(R.drawable.ic_back1);
            iv_15.setImageResource(R.drawable.ic_back1);

            iv_21.setImageResource(R.drawable.ic_back1);
            iv_22.setImageResource(R.drawable.ic_back1);
            iv_23.setImageResource(R.drawable.ic_back1);
            iv_24.setImageResource(R.drawable.ic_back1);
            iv_25.setImageResource(R.drawable.ic_back1);

            iv_31.setImageResource(R.drawable.ic_back1);
            iv_32.setImageResource(R.drawable.ic_back1);
            iv_33.setImageResource(R.drawable.ic_back1);
            iv_34.setImageResource(R.drawable.ic_back1);
            iv_35.setImageResource(R.drawable.ic_back1);

            iv_41.setImageResource(R.drawable.ic_back1);
            iv_42.setImageResource(R.drawable.ic_back1);
            iv_43.setImageResource(R.drawable.ic_back1);
            iv_44.setImageResource(R.drawable.ic_back1);
            iv_45.setImageResource(R.drawable.ic_back1);


            if (turn == 1) {
                turn = 2;
                tv__p1.setTextColor(Color.GRAY);
                tv__p2.setTextColor(Color.BLACK);
            } else if (turn == 2) {
                turn = 1;
                tv__p2.setTextColor(Color.GRAY);
                tv__p1.setTextColor(Color.BLACK);
            }
    ...
    private void checkEnd() {
        if (iv_11.getVisibility() == View.INVISIBLE &&
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MemoryMainActivity1.this);
            alertDialogBuilder
                    ...
                    .setPositiveButton("NEW", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Intent intent = new Intent(getApplicationContext(), MemoryMainActivity1.class);
                    ...
                    .setNegativeButton("EXIT", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Intent intent = new Intent(MemoryMainActivity1.this, Memory.class);
                            startActivity(intent);
                        }
                    });
